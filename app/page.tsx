...
type CarouselSlide = {
  ...
  // --- new (optional) ---
  linkType?: "filter" | "product" | "page" | "url";
  productSlug?: string;
  pagePath?: string;
  url?: string;

  // ao clicar, aplica filtro (modo antigo)
  series?: string;
  category?: string;
          ...
          .map((s: any) => ({
            ...
            linkType:
              ...
              s?.linkType === "url"
                ? s.linkType
                : "filter",
            productSlug: s?.productSlug ? String(s.productSlug) : undefined,
            pagePath: s?.pagePath ? String(s.pagePath) : undefined,
                  ...
                  {isActive && isOpen ? (
                    <div className="accordion">
                      <button
                        ...
                        type="button"
                      >
                        <span>All subcategories in {it.series}</span>
                    ...
                    {s.src ? (
                      ...
                      <div className="slidePlaceholder">
                        ...
                        <div className="phHint">
                          Click to filter:{" "}
                          <strong>{s.series ?? "All Categories"}</strong>
                          {s.category ? (
                            <>
                              {" "}
